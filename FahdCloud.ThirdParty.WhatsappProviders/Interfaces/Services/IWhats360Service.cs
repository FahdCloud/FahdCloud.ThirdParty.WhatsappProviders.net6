...
{
    public interface IWhats360Service
    {
        /// <summary>
        /// Checks the connection status to the Whats360 service using the provided settings.
        /// </summary>
        /// <param name="whats360Setting">The configuration settings for the Whats360 provider.</param>
        ...
        Task<bool> CheckConnectionAsync(Whats360Setting whats360Setting);
        ...
        Task<SendMessageResponse> SendMessageAsync(Whats360Setting whats360Setting, string userPhone, string messageText);
    }
}